...
(1) If you dont have one yet: Create a google account <br>
...
(3) In the window, go to "GitHub", and enter the following address: https://github.com/franzkeaw/NMRC-practicals-2026
...
(4) Important!  Before you do anything else, you need to copy this notebook (which you just opened) to your own google-drive. 
...
(5) Now you can work with the Notebooks. How do they work? <br>
